import os
import sys
sys.path.append('/home/donglai/code/workspace/RNA_GS/RNA_py/local/test/new_avg/les/')
ww=[]
def rest_area(rr):
    tmp=rr[0]
...
Dir='/home/donglai/code/workspace/RNA_GS/RNA_py/local/test/new_avg/les/'
names=['en_roc_l','roc_1_l','roc_2_l']
